...
Version 3 is Generation 1 - Version 3. For the actual code that was sent to the Arduino, go to [a link](https://github.com/jamestlye/Ball-Catch-Device/Catch_Sensor_V3.0/bleuart_datamode/bleuart_datamode.ino)
